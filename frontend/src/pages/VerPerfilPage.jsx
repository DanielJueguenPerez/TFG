            ...
            <div className="flex justify-center mt-6">
                <div className="w-full max-w-md">
                    <Link 
                            ...
                            className="block w-full bg-blue-600 text-center text-white px-4 py-2 rounded hover:bg-blue-700 transition"
                        >
...
function Item({label,valor}){
    return(
        <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{valor}</dd>
        </div>
    );
}